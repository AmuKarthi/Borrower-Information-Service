...
public class BorrowerInformation implements Serializable {
	...
	/*
	 * @OneToMany(mappedBy = "loan_details", cascade = CascadeType.ALL) private
	 * List<LoanInformation> loanInfo;
	 */
	...
	/*
	 * public List<LoanInformation> getLoanInfo() { return loanInfo; }
	 * 
	 * public void setLoanInfo(List<LoanInformation> loanInfo) { this.loanInfo =
	 * loanInfo; }
	 */
